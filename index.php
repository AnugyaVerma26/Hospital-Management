...
<section class="footer" id="fitt">
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"><i class="fas fa-envelope"></i> abc@gmail.com</a>
            <a href="#"><i class="fas fa-map-marker-alt"></i>Rewa Road Old Bridge, near to Yamuna, Naini, Prayagraj, Uttar Pradesh 211007</a>
            </div>
    </div>

    <div class="credit"> created by <span>Apoorv Verma</span> | all rights reserved </div>
